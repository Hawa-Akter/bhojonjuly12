...
let checkBoxIdList = [];
function chkBoxclicked(id) {
  checkBoxIdList.push(id);
}
document
  .getElementById("merge_order")
  .setAttribute("onclick", "mergerOrderList(checkBoxIdList)");
    ...
    <div class="col-sm-4 col-md-3 col-xs-6 col-xlg-2 mb-2">
        <div class="hero-widget well well-md height-auto">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="kitchen-tab bd-pd-overflow">
                        <input id="chkbox-11499" type="checkbox" class="individual"
                            name="margeorder" value="11499" onclick="chkBoxclicked(${ongoingOrder.id})">
            ...
            <div class="allbtn">
                ...
                <a href="#" class="btn btn-xs btn-success btn-sm mx-0 my-1">Split</a>
